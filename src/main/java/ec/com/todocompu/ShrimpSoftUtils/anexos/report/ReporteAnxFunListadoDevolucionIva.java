 ...
 * @author misayo
 */
public class ReporteAnxFunListadoDevolucionIva {
    ...
    private String actClaveAcceso;
    private String actNecesitaSoporte;

    public ReporteAnxFunListadoDevolucionIva() {
    }

    public ReporteAnxFunListadoDevolucionIva(String fechaDesde, String fechaHasta, String actSustentoTributario,
            String actFecha, String actProveedorNombre, Character actProveedorIdTipo, String actProveedorIdNumero,
            String actDocumentoTipo, String actDocumentoNumero, String actAutorizacion, BigDecimal actBase0,
            BigDecimal actBaseImponible, BigDecimal actIva, BigDecimal actTotal, String actClaveAcceso, String actNecesitaSoporte) {
        ...
        this.actClaveAcceso = actClaveAcceso;
    ...
    public String getActClaveAcceso() {
        return actClaveAcceso;
    }

    public void setActClaveAcceso(String actClaveAcceso) {
        this.actClaveAcceso = actClaveAcceso;
    }
