...
public class ReporteListadoRetencionesVentas {
    ...
    public ReporteListadoRetencionesVentas(String desde, String hasta, String venFecha, String venIdentificacion,
            String venNombre, String venComprobanteTipo, String venComprobanteNumero, BigDecimal venBaseNoObjetoIva,
            BigDecimal venBase0, BigDecimal venBaseImponible, BigDecimal venMontoIce, BigDecimal venMontoIva, BigDecimal venValorRetenidoIva,
            BigDecimal venValorRetenidoRenta) {
        this.desde = desde;
        this.hasta = hasta;
