...
public class AnxVentaTO implements java.io.Serializable {
    ...
    public AnxVentaTO(String venEmpresa, String venPeriodo, String venMotivo, String venNumero,
            String venRetencionNumero, String venRetencionAutorizacion, String venRetencionFechaEmision,
            BigDecimal venBase0, BigDecimal venBaseImponible, BigDecimal venBaseNoObjetoIva, BigDecimal venMontoIva,
            BigDecimal venValorRetenidoIva, BigDecimal venValorRetenidoRenta, String usrEmpresa, String usrCodigo,
