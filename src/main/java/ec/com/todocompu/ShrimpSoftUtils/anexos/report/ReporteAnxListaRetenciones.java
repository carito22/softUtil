 ...
 * @author charly
 */
public class ReporteAnxListaRetenciones {
	...
	public ReporteAnxListaRetenciones(String retSustentoTributario, String retProveedorTipo, String retProveedorId,
			String retProveedorNombre, String retProveedorDireccion, String retProveedorCiudad, String retDocumentoTipo,
			String retDocumentoNombre, String retDocumentoAutorizacion, String retDocumentoNumero,
			String retCompraFecha, BigDecimal retCompraBase0, BigDecimal retCompraBaseImponible,
			BigDecimal retCompraMontoIva, String retRetencionAutorizacion, String retRetencionNumero,
			String retRetencionFecha, BigDecimal retValorRetenidoIr, BigDecimal retValorBienes,
			BigDecimal retValorServicios, BigDecimal retValorServiciosProfesionales, BigDecimal retValorRetenidoIva,
			BigDecimal retTotalRetenido, String retModificadoDocumentoTipo, String retModificadoDocumentonumero,
			String retModificadoAutorizacion, String retLlaveCompra, String retLlaveContable) {
	...
	public ReporteAnxListaRetenciones() {
	}
