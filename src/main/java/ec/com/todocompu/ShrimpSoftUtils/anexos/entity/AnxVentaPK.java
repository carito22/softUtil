...
public class AnxVentaPK implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.venEmpresa == null && other.venEmpresa != null)
				|| (this.venEmpresa != null && !this.venEmpresa.equals(other.venEmpresa))) {
			return false;
		}
		if ((this.venPeriodo == null && other.venPeriodo != null)
				|| (this.venPeriodo != null && !this.venPeriodo.equals(other.venPeriodo))) {
			return false;
		}
		if ((this.venMotivo == null && other.venMotivo != null)
				|| (this.venMotivo != null && !this.venMotivo.equals(other.venMotivo))) {
			return false;
		}
		if ((this.venNumero == null && other.venNumero != null)
				|| (this.venNumero != null && !this.venNumero.equals(other.venNumero))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "anexos.entity.AnxVentaPK[ venEmpresa=" + venEmpresa + ", venPeriodo=" + venPeriodo + ", venMotivo="
				+ venMotivo + ", venNumero=" + venNumero + " ]";
	}
