...
public class ReporteConsultaBonosLote {
	...
	public ReporteConsultaBonosLote(String periodo, String tipo, String numero, String dblFecha, String dblId,
			String dblNombres, BigDecimal dblValor, String formaPago, String documento, String observaciones) {
