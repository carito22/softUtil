...
public class RhSalarioDignoTO implements Serializable {
	...
	public RhSalarioDignoTO(String empEmpresa, String empId, String empApellidosNombres, String sdigDesde,
			String sdigHasta, BigDecimal sdigValor, String sdigFormaPago, Boolean sdigReversado, String secCodigo,
			String conEmpresa, String conPeriodo, String conTipo, String conNumero, String conFecha,
			String conDetDocumento, String conObservaciones, String usrCodigo, Integer sdigSecuencial) {
