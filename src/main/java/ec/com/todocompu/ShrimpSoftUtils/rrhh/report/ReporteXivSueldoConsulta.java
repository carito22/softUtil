 ...
 * @author misayo
 */
public class ReporteXivSueldoConsulta {
    // CABECERA
    ...
    public ReporteXivSueldoConsulta() {
    }

    public ReporteXivSueldoConsulta(String sector, String periodo, String fechaDesde, String fechaHasta,
            String fechaMaxima, String xivCategoria, String xivSector, String xivId, String xivNombres,
            String xivApellidos, Character xivGenero, String xivFechaIngreso, String xivCargo,
            BigDecimal xivTotalIngresos, Short xivDiasLaborados, BigDecimal xivValorXivSueldo,
            Character xivCodigoMinisterial, String xivPeriodo, String xivTipo, String xivNumero) {
        this.sector = sector;
