...
public class RhRolCabeceraTO implements Serializable {
	...
	public RhRolCabeceraTO(String empresa, String perCodigo, String tipCodigo, String conNumero, String fechaDesde,
			String fechaHasta, String categoria, String sector, String formaPago, String documento,
			String observaciones, String usuario, Boolean porPagar, Boolean liquidacion, Boolean grabar) {
