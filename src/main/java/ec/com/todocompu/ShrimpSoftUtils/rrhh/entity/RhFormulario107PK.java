...
public class RhFormulario107PK implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.f107Empresa == null && other.f107Empresa != null)
				|| (this.f107Empresa != null && !this.f107Empresa.equals(other.f107Empresa))) {
			return false;
		}
		if ((this.f107Anio == null && other.f107Anio != null)
				|| (this.f107Anio != null && !this.f107Anio.equals(other.f107Anio))) {
			return false;
		}
		if ((this.f107Id == null && other.f107Id != null)
				|| (this.f107Id != null && !this.f107Id.equals(other.f107Id))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "rrhh.entity.RhFormulario107PK[ f107Empresa=" + f107Empresa + ", f107Anio=" + f107Anio + ", f107Id="
				+ f107Id + " ]";
	}
}
