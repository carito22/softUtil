 ...
 */
public class RhAvisoEntradaTO implements Serializable {
	/**
	 * 
	 */
	...
	public RhAvisoEntradaTO() {
	}

	public RhAvisoEntradaTO(String empCodigo, String empId, String empNombres, String empFechaAfiliacionIess,
			String empCodigoAfiliacionIess, String empCodigoCargoIess, BigDecimal empSueldoIess, String usrCodigo) {
