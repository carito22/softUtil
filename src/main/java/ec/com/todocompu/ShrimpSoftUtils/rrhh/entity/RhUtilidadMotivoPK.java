...
@Embeddable
public class RhUtilidadMotivoPK implements Serializable {
	private static final long serialVersionUID = 1L;

	private String motEmpresa;
	private String motDetalle;

	public RhUtilidadMotivoPK() {
	}

	public RhUtilidadMotivoPK(String motEmpresa, String motDetalle) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof RhUtilidadMotivoPK)) {
			return false;
		}
		RhUtilidadMotivoPK other = (RhUtilidadMotivoPK) object;
