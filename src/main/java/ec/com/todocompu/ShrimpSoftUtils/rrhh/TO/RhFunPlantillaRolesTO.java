...
public class RhFunPlantillaRolesTO implements Serializable {
	...
	public RhFunPlantillaRolesTO(String prId, String prNombres, String prCargo, BigDecimal prSueldoReal,
			String prUltimoSueldo, String prFormaPago, Boolean prAfiliado, Boolean prRetencion, Boolean prFondoReserva,
			String prFechaAfiliacionIess, String prPrimerIngreso, String prPrimeraSalida, String prUltimoIngreso,
			String prUltimaSalida, BigDecimal prPorPagar, BigDecimal prAnticipos, BigDecimal prPrestamos,
			BigDecimal prBonos, BigDecimal prBonosNd, BigDecimal prViaticos, Integer id) {
		this.prId = prId;
