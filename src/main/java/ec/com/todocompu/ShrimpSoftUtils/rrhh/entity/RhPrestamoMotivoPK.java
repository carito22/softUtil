...
@Embeddable
public class RhPrestamoMotivoPK implements Serializable {
	private static final long serialVersionUID = 1L;

	private String motEmpresa;
	private String motDetalle;

	public RhPrestamoMotivoPK() {
	}

	public RhPrestamoMotivoPK(String motEmpresa, String motDetalle) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof RhPrestamoMotivoPK)) {
			return false;
		}
		RhPrestamoMotivoPK other = (RhPrestamoMotivoPK) object;
