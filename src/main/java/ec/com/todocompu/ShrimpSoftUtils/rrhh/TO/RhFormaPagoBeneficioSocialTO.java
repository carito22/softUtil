...
@Entity
public class RhFormaPagoBeneficioSocialTO implements Serializable {
	...
	public RhFormaPagoBeneficioSocialTO() {
	}

	public RhFormaPagoBeneficioSocialTO(Integer fpSecuencial, String fpDetalle, String fpCodigoMinisterial,
			Boolean fpInactivo, String secCodigo, String ctaCodigo, String usrEmpresa, String usrCodigo,
