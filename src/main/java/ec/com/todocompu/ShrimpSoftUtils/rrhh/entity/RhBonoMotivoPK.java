...
@Embeddable
public class RhBonoMotivoPK implements Serializable {
	private static final long serialVersionUID = 1L;

	private String motEmpresa;
	private String motDetalle;

	public RhBonoMotivoPK() {
	}

	public RhBonoMotivoPK(String motEmpresa, String motDetalle) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof RhBonoMotivoPK)) {
			return false;
		}
		RhBonoMotivoPK other = (RhBonoMotivoPK) object;
