 ...
 */
@Entity
public class RhPreavisoAnticiposPrestamosSueldoPichinchaTO implements java.io.Serializable {
    ...
    @Column(name = "pre_cuenta_empresa")
    private String preCuentaEmpresa;

    public RhPreavisoAnticiposPrestamosSueldoPichinchaTO() {
    }

    public RhPreavisoAnticiposPrestamosSueldoPichinchaTO(String preTipoRegistro, String preSecuencial, String preCodigo,
            String preMoneda, String preTotalPagado, String preCuenta, String preCuentaTipo, String preCuentaNumero,
            String preReferencia, String preBeneficiarioTipoId, String preBeneficiarioNumeroId,
            String preBeneficiarioNombre, String preCodigoBanco, String prePrefijoEmpresarial) {
    ...
    public String getPreCuentaEmpresa() {
        return preCuentaEmpresa;
    }

    public void setPreCuentaEmpresa(String preCuentaEmpresa) {
        this.preCuentaEmpresa = preCuentaEmpresa;
    }
