 ...
 */
@Entity
public class RhFormaPagoTO implements Serializable {
	...
	public RhFormaPagoTO() {
	}

	public RhFormaPagoTO(Integer fpSecuencial, String fpDetalle, Boolean fpInactivo, String secCodigo, String ctaCodigo,
