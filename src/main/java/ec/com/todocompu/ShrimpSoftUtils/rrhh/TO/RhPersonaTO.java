...
public class RhPersonaTO implements Serializable {
	...
	public RhPersonaTO(String empCodigo, String empCedula, String empNombres, String empApellidos,
			String empFechaNacimiento, String empEstadoCivil, BigDecimal empSueldo, Boolean empAfiliado,
			String empObservaciones, String usrEmpresa, String usrCodigo, Date usrFechaInserta) {
