...
@Embeddable
public class RhXiiiSueldoMotivoPK implements Serializable {
	private static final long serialVersionUID = 1L;

	private String motEmpresa;
	private String motDetalle;

	public RhXiiiSueldoMotivoPK() {
	}

	public RhXiiiSueldoMotivoPK(String motEmpresa, String motDetalle) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof RhXiiiSueldoMotivoPK)) {
			return false;
		}
		RhXiiiSueldoMotivoPK other = (RhXiiiSueldoMotivoPK) object;
