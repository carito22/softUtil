    ...
    public static String comprobacion(String cadena) {
        ...
        if (cadena.equals("")) {
            ...
            boolean e1 = !(Integer.parseInt(cadena.substring(0, 2)) >= 1
                    && Integer.parseInt(cadena.substring(0, 2)) <= 30);
            ...
            String sub13 = cadena.substring(10, 13);
            boolean e3 = (!sub13.equals("001") && !(sub13.trim().isEmpty()));
            ...
            if (e1 || e2 || e3) {
                ...
                try {
                    ...
                    if (resultado1 != 0 && esCedula) {
                        mensaje = "Cedula incorrecta";
                    }

                    // Para Ruc Sociedades Privadas
                    resultado2 = ((n1 * 4) + (n2 * 3) + (n3 * 2) + (n4 * 7) + (n5 * 6) + (n6 * 5) + (n7 * 4) + (n8 * 3)
                            + (n9 * 2) + n10) % 11;

                    // Para Ruc Sociedades Públicas
                    resultado3 = ((n1 * 3) + (n2 * 2) + (n3 * 7) + (n4 * 6) + (n5 * 5) + (n6 * 4) + (n7 * 3) + (n8 * 2)
                            + n9) % 11;*/

                    //boolean c1 = (resultado1 == 0 || (resultado1 != 0 && !esCedula));
                    /*boolean c2 = (Integer.parseInt(cadena.substring(2, 3)) >= 0 && Integer.parseInt(cadena.substring(2, 3)) <= 6);
                    boolean c3 = (cadena.substring(10, 13).equals("001") || cadena.substring(10, 13).trim().isEmpty());*/
                   // boolean c4 = ((resultado2 == 0 || (resultado2 != 0 && !esCedula)) && n3 == 9 && cadena.substring(10, 13).equals("001"));
                   // boolean c5 = (resultado3 == 0 && n3 == 6 && cadena.substring(9, 13).equals("0001"));
                   //if (((c1 && c2 && c3) || c4) || c5)
                   mensaje = "T";
                    /*if (c2 && c3) {
