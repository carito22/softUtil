 ...
 */
public class InvListaConsultaConsumo {
	...
	public InvListaConsultaConsumo() {
	}

	public InvListaConsultaConsumo(String desde, String hasta, String status, String consStatus, String consFecha,
			String consObservaciones, String consNumero) {
		this.desde = desde;
		this.hasta = hasta;
		this.status = status;
