...
public class InvListaConsultaTransferencia {
	...
	public InvListaConsultaTransferencia(String desde, String hasta, String status, String transStatus,
			String transFecha, String transObservaciones, String transNumero) {
		this.desde = desde;
		this.hasta = hasta;
		this.status = status;
