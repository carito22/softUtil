...
public class InvListaProductosCompraSustentoConceptoTO implements java.io.Serializable {
    ...
    public InvListaProductosCompraSustentoConceptoTO(String proCodigoPrincipal, BigDecimal subtotal, String conCodigo,
            String susCodigo, BigDecimal base0, BigDecimal baseImponible, BigDecimal detPorcentaje,
            BigDecimal detValorRetenido, BigDecimal detBaseNoObjetoIva) {
