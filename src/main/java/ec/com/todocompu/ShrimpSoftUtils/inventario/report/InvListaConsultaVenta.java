 ...
 */
public class InvListaConsultaVenta {
	...
	public InvListaConsultaVenta() {
	}

	public InvListaConsultaVenta(String desde, String hasta, String status, String vtaStatus, String vtaDocumentoNumero,
			String vtaFecha, String cliCodigo, String cliNombre, BigDecimal vtaBase0, BigDecimal vtaBaseImponible,
			BigDecimal vtaMontoIva, BigDecimal vtaTotal, String vtaFormaPago, String vtaObservaciones, String vtaNumero,
			String conNumero) {
		this.desde = desde;
		this.hasta = hasta;
		this.status = status;
