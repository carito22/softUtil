 ...
 */
@Entity
public class InvNumeracionVentaTO implements java.io.Serializable {
	...
	public InvNumeracionVentaTO() {
	}

	public InvNumeracionVentaTO(String numEmpresa, String numPeriodo, String numMotivo, String numSecuencia,
			Integer numId) {
