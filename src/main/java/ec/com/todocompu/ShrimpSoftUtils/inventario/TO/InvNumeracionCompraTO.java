 ...
 */
@Entity
public class InvNumeracionCompraTO implements java.io.Serializable {
	...
	public InvNumeracionCompraTO() {
	}

	public InvNumeracionCompraTO(String numEmpresa, String numPeriodo, String numMotivo, String numSecuencia,
			Integer numId) {
