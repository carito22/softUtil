...
@Embeddable
public class InvTransferenciasNumeracionPK implements Serializable {
	...
	public InvTransferenciasNumeracionPK() {
	}

	public InvTransferenciasNumeracionPK(String numEmpresa, String numPeriodo, String numMotivo) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof InvTransferenciasNumeracionPK)) {
			return false;
		}
		InvTransferenciasNumeracionPK other = (InvTransferenciasNumeracionPK) object;
	...
	public String toString() {
		return "inventario.entity.InvTransferenciasNumeracionPK[ numEmpresa=" + numEmpresa + ", numPeriodo="
				+ numPeriodo + ", numMotivo=" + numMotivo + " ]";
	}
