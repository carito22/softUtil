...
@Embeddable
public class InvProformasNumeracionPK implements Serializable {
	...
	public InvProformasNumeracionPK() {
	}

	public InvProformasNumeracionPK(String numEmpresa, String numPeriodo, String numMotivo) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof InvProformasNumeracionPK)) {
			return false;
		}
		InvProformasNumeracionPK other = (InvProformasNumeracionPK) object;
	...
	public String toString() {
		return "inventario.entity.InvProformasNumeracionPK[ numEmpresa=" + numEmpresa + ", numPeriodo=" + numPeriodo
				+ ", numMotivo=" + numMotivo + " ]";
	}
