...
public class DatoFunListaProductosImpresionPlaca implements Serializable {
    ...
    public DatoFunListaProductosImpresionPlaca() {
    }

    public DatoFunListaProductosImpresionPlaca(String lpspCodigoPrincipal, String lpspCodigoBarra, String lpspNombre,
            String proEmpaque, BigDecimal lpspPrecio1, BigDecimal lpspPrecio2, BigDecimal lpspPrecio3, boolean estado) {
