...
public class InvComprasFormaPagoTO implements Serializable {
    ...
    public InvComprasFormaPagoTO(Integer fpSecuencial, String fpDetalle, Boolean fpInactivo,
            String ctaCodigo, String usrEmpresa, String usrCodigo, String usrFechaInserta, String fpTipoPrincipal) {
