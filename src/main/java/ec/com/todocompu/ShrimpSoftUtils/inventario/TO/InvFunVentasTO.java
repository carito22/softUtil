 ...
 */
@Entity
public class InvFunVentasTO implements java.io.Serializable {
    ...
    @Column(name = "vta_ice")
    private java.math.BigDecimal vtaIce;
    ...
    private String vtaContable;

    @Column(name = "vta_ge_codigo")
    private String vtaGeCodigo;

    @Column(name = "vta_sector")
    private String vtaSector;

    public InvFunVentasTO() {
    }

    public InvFunVentasTO(Integer id, String vtaNumeroSistema, String vtaFecha, String vtaIdentificacion,
            String vtaCliente, String vtaDocumentoNumero, BigDecimal vtaCantidad, BigDecimal vtaBase0,
            BigDecimal vtaBaseImponible, BigDecimal vtaIce, BigDecimal vtaMontoIva, BigDecimal vtaTotal, String vtaFormaPago,
    ...
    public String getVtaContable() {
        return vtaContable;
    }

    public void setVtaContable(String vtaContable) {
        this.vtaContable = vtaContable;
    }

    public String getVtaGeCodigo() {
        return vtaGeCodigo;
    }

    public void setVtaGeCodigo(String vtaGeCodigo) {
        this.vtaGeCodigo = vtaGeCodigo;
    }
    ...
    public BigDecimal getVtaIce() {
        return vtaIce;
    }

    public void setVtaIce(BigDecimal vtaIce) {
        this.vtaIce = vtaIce;
    }
