...
public class SaldoBodegaComprobacionTO implements java.io.Serializable {
    ...
    @Column(name = "sbc_producto_cuenta")
    private String sbcProductoCuenta;
    ...
    @Column(name = "sbc_transferencia_e") // sbc_transferencia_e
    ...
    public SaldoBodegaComprobacionTO(String sbcProductoNombre, String sbcProductoCodigo, String sbcMedida,
            ...
            BigDecimal sbcDevolucionV, BigDecimal sbcFinal, BigDecimal sbcDiferencia, Integer id) {
    ...
    public String getSbcProductoCuenta() {
        return sbcProductoCuenta;
    }

    public void setSbcProductoCuenta(String sbcProductoCuenta) {
        this.sbcProductoCuenta = sbcProductoCuenta;
    }
