...
@Embeddable
public class InvComprasNumeracionPK implements Serializable {
	...
	public InvComprasNumeracionPK() {
	}

	public InvComprasNumeracionPK(String numEmpresa, String numPeriodo, String numMotivo) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof InvComprasNumeracionPK)) {
			return false;
		}
		InvComprasNumeracionPK other = (InvComprasNumeracionPK) object;
	...
	public String toString() {
		return "inventario.entity.InvComprasNumeracionPK[ numEmpresa=" + numEmpresa + ", numPeriodo=" + numPeriodo
				+ ", numMotivo=" + numMotivo + " ]";
	}
