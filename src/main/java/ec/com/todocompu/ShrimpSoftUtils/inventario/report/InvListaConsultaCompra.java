 ...
 */
public class InvListaConsultaCompra {
	...
	public InvListaConsultaCompra() {
	}

	public InvListaConsultaCompra(String desde, String hasta, String status, String compStatus,
			String compDocumentoNumero, String compFecha, String provCodigo, String provRazonSocial, BigDecimal compBase0,
			BigDecimal compBaseImponible, BigDecimal compMontoIva, BigDecimal compTotal, String compFormaPago,
			String compObservaciones, String compNumero, String conContable) {
		this.desde = desde;
		this.hasta = hasta;
		this.status = status;
