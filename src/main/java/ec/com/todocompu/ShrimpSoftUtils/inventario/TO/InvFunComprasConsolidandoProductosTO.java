...
public class InvFunComprasConsolidandoProductosTO implements java.io.Serializable {
	...
	public InvFunComprasConsolidandoProductosTO(String ccpProducto, String ccpCodigo, String ccpMedida,
			BigDecimal ccpCantidad, BigDecimal ccpTotal, BigDecimal ccpPorcentaje, Integer id) {
