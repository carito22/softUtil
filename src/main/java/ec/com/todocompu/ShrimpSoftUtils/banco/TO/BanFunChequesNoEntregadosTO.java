 ...
 */
@Entity
public class BanFunChequesNoEntregadosTO implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public BanFunChequesNoEntregadosTO() {
	}

	public BanFunChequesNoEntregadosTO(String chqCuentaCodigo, String chqCuentaDetalle, String chqBeneficiario,
			String chqNumero, BigDecimal chqValor, String chqFechaEmision, String chqFechaVencimiento,
			String chqObservacion, Boolean chqImpreso, Boolean chqRevisado, String chqContablePeriodo,
