...
public class BanListaChequeTO implements java.io.Serializable {
    ...
    @Column(name = "chq_status")
    private String chqStatus;

    public BanListaChequeTO() {
    }

    public BanListaChequeTO(String chqCuentaCodigo, String chqCuentaDetalle, String chqBeneficiario, String chqNumero,
            BigDecimal chqValor, String chqFechaEmision, String chqFechaVencimiento, Boolean chqImpreso,
            Boolean chqRevisado, Boolean chqEntregado, String chqContablePeriodo, String chqContableTipo,
            String chqContableNumero, BigInteger chqSecuencia, BigInteger chqOrden, Integer id) {
