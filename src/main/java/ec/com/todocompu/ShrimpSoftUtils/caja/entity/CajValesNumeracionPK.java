...
@Embeddable
public class CajValesNumeracionPK implements Serializable {
	...
	public CajValesNumeracionPK() {
	}

	public CajValesNumeracionPK(String numEmpresa, String numPeriodo, String numMotivo) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof CajValesNumeracionPK)) {
			return false;
		}
		CajValesNumeracionPK other = (CajValesNumeracionPK) object;
	...
	public String toString() {
		return "caja.entity.CajValesNumeracionPK[ numEmpresa=" + numEmpresa + ", numPeriodo=" + numPeriodo
				+ ", numMotivo=" + numMotivo + " ]";
	}
