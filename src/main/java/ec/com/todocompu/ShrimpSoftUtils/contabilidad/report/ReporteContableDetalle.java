...
public class ReporteContableDetalle {
    ...
    private String detCentroProduccionNombre;
    ...
    public ReporteContableDetalle(String titulo, String empCodigo, String perCodigo, String tipCodigo, String conNumero,
            String conFecha, Boolean conPendiente, Boolean conRevisado, Boolean conAnulado, Boolean conGenerado,
            String conConcepto, String conDetalle, String conObservaciones, String usrInserta, String usrFechaInserta,
            String impElaborado, String impAprobado, String impRevisado, String impContabilidad,
            String conCtaCodigoPadre, String conNombreCuentaPadre, String conCtaCodigo, String conNombreCuenta,
            String detCentroProduccion, String detCentroCosto, String detDocumento, Character detDebitoCredito,
			BigDecimal detValor, Boolean detGenerado, String detReferencia, Integer detOrden, Integer detSecuencia) {
    ...
    public String getDetCentroProduccionNombre() {
        return detCentroProduccionNombre;
    }

    public void setDetCentroProduccionNombre(String detCentroProduccionNombre) {
        this.detCentroProduccionNombre = detCentroProduccionNombre;
    }
