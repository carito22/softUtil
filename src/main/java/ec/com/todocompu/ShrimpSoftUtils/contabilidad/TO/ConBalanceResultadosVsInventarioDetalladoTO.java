 ...
 */
@Entity
public class ConBalanceResultadosVsInventarioDetalladoTO implements java.io.Serializable {
    ...
    @Column(name = "bri_codigo_producto")
    private String vriCodigoProducto;
    ...
    public ConBalanceResultadosVsInventarioDetalladoTO(String vriCuentaContable, String vriNombre,
    ...
    public ConBalanceResultadosVsInventarioDetalladoTO() {
    }
    ...
    public String getVriCodigoProducto() {
        return vriCodigoProducto;
    }

    public void setVriCodigoProducto(String vriCodigoProducto) {
        this.vriCodigoProducto = vriCodigoProducto;
    }
