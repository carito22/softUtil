 ...
 */
@Entity
@Table(name = "sis_suceso_cobro", schema = "sistemaweb")
public class SisSucesoCobro implements Serializable {
    ...
    public SisSucesoCobro() {
    }

    public SisSucesoCobro(Integer susSecuencial, String susJson, SisSuceso sisSuceso, CarCobros carCobros) {
