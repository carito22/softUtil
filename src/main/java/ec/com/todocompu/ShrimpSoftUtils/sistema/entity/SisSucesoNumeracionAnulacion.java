 ...
 */
@Entity
@Table(name = "sis_suceso_numeracion_anulacion", schema = "sistemaweb")
public class SisSucesoNumeracionAnulacion implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "anu_secuencial", referencedColumnName = "anu_secuencial")
    })
    @ManyToOne
    private AnxAnulados anxAnulados;

    public SisSucesoNumeracionAnulacion() {
    }
    ...
    public AnxAnulados getAnxAnulados() {
        return anxAnulados;
    }

    public void setAnxAnulados(AnxAnulados anxAnulados) {
        this.anxAnulados = anxAnulados;
    }
