 ...
 */
@Entity
public class CarFunPagosPruebaTO implements java.io.Serializable {
	...
	public CarFunPagosPruebaTO() {
	}

	public CarFunPagosPruebaTO(String pagNumeroSistema, String pagFecha, String pagProveedor, BigDecimal pagValor,
