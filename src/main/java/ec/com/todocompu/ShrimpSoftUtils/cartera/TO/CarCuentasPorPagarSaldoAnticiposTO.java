...
@Entity
public class CarCuentasPorPagarSaldoAnticiposTO implements java.io.Serializable {
    ...
    public CarCuentasPorPagarSaldoAnticiposTO() {
    }

    public CarCuentasPorPagarSaldoAnticiposTO(Integer id, String antPeriodo, String antTipo, String antNumero,
            String antSector, String antFecha, BigDecimal antValor, String antProveedorCodigo,
            String antProveedorRazonSocial, String antObservaciones) {
