...
public class ReporteCobros {
	...
	private java.math.BigDecimal cobSaldoAnterior;
	private java.math.BigDecimal cobValor;
	private java.math.BigDecimal cobSaldoActual;

	public ReporteCobros() {
	}

	public ReporteCobros(String fecha, String cliente, String id, String nombre, String direccion, String observaciones,
			String numeroCobro, String periodo, String motivo, String numero, String alterno, String documento,
			String sector, String fechaDetalle, String vence, BigDecimal total, BigDecimal valor,
			...
			String antNumero, String antFecha, BigDecimal antValor, BigDecimal antTotal, BigDecimal cobSaldoAnterior,
	...
	public java.math.BigDecimal getCobSaldoAnterior() {
		return cobSaldoAnterior;
	}

	public void setCobSaldoAnterior(java.math.BigDecimal cobSaldoAnterior) {
		this.cobSaldoAnterior = cobSaldoAnterior;
	}

	public java.math.BigDecimal getCobValor() {
		return cobValor;
	}

	public void setCobValor(java.math.BigDecimal cobValor) {
		this.cobValor = cobValor;
	}

	public java.math.BigDecimal getCobSaldoActual() {
		return cobSaldoActual;
	}

	public void setCobSaldoActual(java.math.BigDecimal cobSaldoActual) {
		this.cobSaldoActual = cobSaldoActual;
	}
	...
	public String toString() {
		return this.fecha + " " + this.cliente + " " + this.id + " " + this.nombre + " " + this.direccion + " "
				+ this.observaciones + " " + this.periodo + " " + this.numeroCobro + " " + this.motivo + " "
