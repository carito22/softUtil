 ...
 */
@Entity
public class CarCuentasPorPagarDetalladoTO implements java.io.Serializable {
	...
	public CarCuentasPorPagarDetalladoTO() {
	}

	public CarCuentasPorPagarDetalladoTO(String cxpdPeriodo, String cxpdMotivo, String cxpdNumero, String cxpdProveedor,
			String cxpdFechaEmision, String cxpdFechaVencimiento, BigDecimal cxpdSaldo) {
