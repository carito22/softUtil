...
public class ReporteCarFunCuentasPorCobrarListadoVentas {
	...
	private java.math.BigDecimal cxcdSaldo;

	public ReporteCarFunCuentasPorCobrarListadoVentas() {
	}

	public ReporteCarFunCuentasPorCobrarListadoVentas(String codigoCP, String fechaHasta, String cxcdPeriodo,
			String cxcdMotivo, String cxcdNumero, String cxcdCliente, String cxcdFechaEmision,
			String cxcdFechaVencimiento, BigDecimal cxcdSaldo) {
