...
public class ReporteListadoPagos {
	...
	public ReporteListadoPagos(String desde, String hasta, String proveedor, String pagNumeroSistema, String pagFecha,
			String pagProveedor, BigDecimal pagValor, String pagObservaciones, Boolean pagPendiente,
			Boolean pagAnulado) {
