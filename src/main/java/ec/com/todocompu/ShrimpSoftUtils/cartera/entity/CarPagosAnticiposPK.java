...
@Embeddable
public class CarPagosAnticiposPK implements Serializable {
	...
	public CarPagosAnticiposPK() {
	}

	public CarPagosAnticiposPK(String antEmpresa, String antPeriodo, String antTipo, String antNumero) {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof CarPagosAnticiposPK)) {
			return false;
		}
		CarPagosAnticiposPK other = (CarPagosAnticiposPK) object;
	...
	public String toString() {
		return "cartera.entity.CarPagosAnticiposPK[ antEmpresa=" + antEmpresa + ", antPeriodo=" + antPeriodo
