 ...
 */
@Entity
public class CarCobrosDetalleAnticiposTO implements Serializable {
	...
	public CarCobrosDetalleAnticiposTO() {
	}

	public CarCobrosDetalleAnticiposTO(BigDecimal detValor, String detObservaciones, String antEmpresa,
