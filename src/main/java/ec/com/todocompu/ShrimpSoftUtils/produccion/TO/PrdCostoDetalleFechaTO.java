...
@Entity
public class PrdCostoDetalleFechaTO implements java.io.Serializable {
	...
	public PrdCostoDetalleFechaTO() {
	}

	public PrdCostoDetalleFechaTO(String costoProducto, String costoCodigo, String costoMedida,
