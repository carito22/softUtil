 ...
 */
@Entity
public class PrdLiquidacionDetalleProductoEmpacadoraTO implements Serializable {
    ...
    public PrdLiquidacionDetalleProductoEmpacadoraTO() {
    }

    public PrdLiquidacionDetalleProductoEmpacadoraTO(Integer id, String liqNumeroSistema, Date liqFecha, String liqProveedorId, String liqProveedorRazonSocial,
            String liqLote, String detProductoCodigo, String detProductoNombre, String detProductoClase, String detProductoTipo,
            BigDecimal detLibras, BigDecimal detPrecio, String pisSector, String pisNumero, String liqTallaCodigo, String liqTallaDetalle,
            String liqTipoCodigo, String liqTipoDetalle) {
    ...
    public String toString() {
        return "PrdLiquidacionDetalleProductoEmpacadoraTO{" + "id=" + id + ", liqNumeroSistema=" + liqNumeroSistema + ", liqFecha=" + liqFecha + ", liqProveedorId=" + liqProveedorId + ", liqProveedorRazonSocial=" + liqProveedorRazonSocial + ", liqLote=" + liqLote + ", detProductoCodigo=" + detProductoCodigo + ", detProductoNombre=" + detProductoNombre + ", detProductoClase=" + detProductoClase + ", detProductoTipo=" + detProductoTipo + ", detLibras=" + detLibras + ", detPrecio=" + detPrecio + ", pisSector=" + pisSector + ", pisNumero=" + pisNumero + ", liqTallaCodigo=" + liqTallaCodigo + ", liqTallaDetalle=" + liqTallaDetalle + ", liqTipoCodigo=" + liqTipoCodigo + ", liqTipoDetalle=" + liqTipoDetalle + ", liqComisionista=" + liqComisionista + ", prdComisionista" + prdComisionista + '}';
    }
