...
public class PrdLiquidacionCabeceraTO implements Serializable {
	...
	public PrdLiquidacionCabeceraTO(String liqLote, String liqFecha, BigDecimal liqLibrasEnviadas,
			BigDecimal liqLibrasRecibidas, BigDecimal liqLibrasBasura, BigDecimal liqLibrasRetiradas,
			BigDecimal liqLibrasNetas, BigDecimal liqLibrasEntero, BigDecimal liqLibrasCola,
			BigDecimal liqLibrasColaProcesadas, BigDecimal liqAnimalesCosechados, BigDecimal liqTotalMonto,
			boolean liqPendiente, boolean liqAnulado, String cliEmpresa, String cliCodigo, String pisEmpresa,
			String pisSector, String pisNumero, String usrEmpresa, String usrCodigo, String usrFechaInserta) {
