...
public class CarteraVerificarDeudasNelsonBenavidesDelegate {

	private static CarteraVerificarDeudasNelsonBenavidesDelegate grupoDelegate;
	private RestTemplate restTemplate = new RestTemplate();
	private String conexionWSVerificarDeudas;

	private CarteraVerificarDeudasNelsonBenavidesDelegate() throws Exception {
		conexionWSVerificarDeudas = "https://ows.acosux.com/api/todocompuWS/carteraController";
	}

	public static CarteraVerificarDeudasNelsonBenavidesDelegate getInstance() {
		if (grupoDelegate == null) {
			try {
				grupoDelegate = new CarteraVerificarDeudasNelsonBenavidesDelegate();
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
